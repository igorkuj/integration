...
public class JmsOutbound {
    ...
    @Bean
    public IntegrationFlow jmsOutboundFlow(ActiveMQConnectionFactory connectionFactory, DirectChannel fileCleanupChannel) {
        return IntegrationFlow
                ...
                .log(LoggingHandler.Level.INFO, "jms.outbound.flow", m -> "Sending to queue: " + m.getHeaders().get("jms_destination"))
